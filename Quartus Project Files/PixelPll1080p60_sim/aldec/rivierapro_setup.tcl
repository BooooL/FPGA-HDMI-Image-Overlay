...
# ACDS 17.1 590 win32 2018.05.29.21:59:00
# ----------------------------------------
...
# ----------------------------------------
# If PixelPll1080p60 is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "PixelPll1080p60"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "G:/software/quartus/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PixelPll1080p60.vo"
}
